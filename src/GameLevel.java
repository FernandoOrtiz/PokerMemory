...
public abstract class GameLevel implements ActionListener 
{
	...
	protected ScoreCounter scoreCounter;						// Keeps score
	 ...
	 */
	protected GameLevel(TurnsTakenCounterLabel counterLabel, int cardsToGuess, JFrame mainFrame, ScoreCounter scoreCounter)
	{
